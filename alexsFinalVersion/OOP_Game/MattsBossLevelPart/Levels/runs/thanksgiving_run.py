import pygame
import sys
from MattsBossLevelPart.Levels.holidays.thanksgiving import Thanksgiving
from MattsBossLevelPart.Levels.bosses.thanksgivingBoss.turkey_nn import TurkeyNN
import random
from datetime import datetime
from .thanksgiving_attacks import ThanksgivingAttacks
import torch

def runThanksgiving(score):
    
    running = True

    h_obj = Thanksgiving()
    attacks = ThanksgivingAttacks()
    ...
    b_attack = False
    b_IS_alive = True
    boss_upload_time = float(random.randint(2,5)/2)
    p_IS_alive = True
    p_start = None
    p_attack = False
    power_up = False
    ...
    text_surf1 = font.render(str(player.score), True, (0, 0, 200))
    text_surf2 = font.render(str(player.score), True, (0,0,0))
    ...
    while running:
        ...
        setting.blit(text_surf2, (400,50))
        text_surf1 = font.render(str(player.score), True, (255,165,0))
        setting.blit(text_surf1, (400,50))
        text_surf2 = font.render(str(player.score), True, (0,0,0))
