...
class Gates(pygame.sprite.Sprite):
	...
	def traverse(self):
		...
		if self.game.level == 0:
			self.game.wall_spritesheet = Spritesheet('AlexsPreBossLevelPart/OOP_Game/img/Thanksgiving_Wall_Sheet.png', 4, 4, 32, [4,4,4,4], 0)
			self.game.enemy_spritesheet = Spritesheet('AlexsPreBossLevelPart/OOP_Game/img/Thanksgiving_Enemy_Sheet.png', 6, 5, 32, [4, 3, 4, 4, 5, 5, 5], 4)
		if self.game.level == 1:
			self.game.wall_spritesheet = Spritesheet('AlexsPreBossLevelPart/OOP_Game/img/Christmas_Wall_Sheet.png', 4, 4, 32, [4,4,4,4], 0)
...
class Button:
	def __init__(self, x, y, width, height, fg, bg, content, fontsize):
		self.font = pygame.font.Font('AlexsPreBossLevelPart/OOP_Game/Arial.ttf', fontsize)
